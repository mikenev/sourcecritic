  ...
  <div class="modal-dialog">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <input type="text" ng-model="reviewName" placeholder="Review Name" />
            <input type="file" ng-model="fileToUpload" id="fileToUpload" />
        </div>
        <div class="modal-footer">
            <button type="button" class="btn btn-default" data-dismiss="modal" ng-click="closeNewReviewModal($event)">Close</button>
            <button type="button" class="btn btn-primary" ng-click="createReview($event)">Create review</button>
        </div>
    </div>
  </div>
</div>